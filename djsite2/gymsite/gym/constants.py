OPENAI_API_KEY = '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'

GenderChoice = (('M', 'Male'), ('F', 'Female'))

CardDiscountChoice = ((1, 10), (2, 20), (3, 30), (4, 40))
CardNameChoice = (('B', 'Bronze'), ('S', 'Silver'), ('G', 'Gold'), ('D', 'Diamond'))
